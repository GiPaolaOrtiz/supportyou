    ...
    <body>
        <main>
            ...
            <?php 
                    ...
                    $ObjMetodo=$ciudadCollectorObj->showciudad($id);
            ?>
                    ...
                    <div class="col-md-4">
                        <form method="post" action="editar.php">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="idm" value="<?php echo $ObjMetodo->getId(); ?>" readonly name="id">
                            </div>
                             <div class="form-group">
                              <label for="metodo">Metodo de pago</label>
                              <input type="text" class="form-control" id="metodo" value="<?php echo $ObjMetodo->getNombre(); ?>" name="metodo">
                            </div>

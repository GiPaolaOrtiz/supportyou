    ...
    <body>
        <main>
            ...
            <?php 
                    ...
                    include_once('../../modelo/moneda/monedaCollector.php');
                    $monedaCollectorObj = new monedaCollector();
                    $Obj=$monedaCollectorObj->showmoneda($id);
            ?>
                    ...
                    <div class="col-md-4">
                        <form method="post" action="editar.php">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="idm" value="<?php echo $Obj->getId(); ?>" readonly name="id">
                            </div>
                             <div class="form-group">
                              <label for="nombre">Nombre</label>
                              <input type="text" class="form-control" id="nombre" value="<?php echo $Obj->getNombre(); ?>" name="nombre">
                            </div>
                            <div class="form-group">

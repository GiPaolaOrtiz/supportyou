    ...
    <body>
        ...
        <?php 
            ...
            $MetodoPagoCollectorObj = new metodopagoCollector();
                ...
                echo "<a href='Eliminar.php' class='btn btn-warning center-block w10'><b>+</b></a>";
                echo '<div class="">';                     
                    ...
                    echo '</tr> </thead><tbody>';            
                      foreach ($MetodoPagoCollectorObj->showMetodoPagos() as $c){
                          echo '<tr>'; 
                              ...
                              echo "<td> <a href='FormularioActualizar.php?id=" . $c->getIdmetodopago() . "' class='btn btn-info mg'>Editar</a>";
